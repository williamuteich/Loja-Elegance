  ...
  return (
    <div className="min-h-screen flex justify-center bg-white">
      <div className="w-full max-w-md mx-auto bg-white p-8 rounded-2xl text-center">
        <h1 className="text-2xl font-bold text-pink-700 mb-6 uppercase">Verificação de E-mail</h1>
        ...
        {status === 'success' ? (
          <>
            ...
            <h2 className="text-xl font-bold text-green-700 mb-2">Verificação bem-sucedida!</h2>
            <p className="text-gray-600 mb-6">
              Seu e-mail foi confirmado. Redirecionando para login...
            </p>
          ...
          <>
            ...
            <h2 className="text-xl font-bold text-red-600 mb-2">Erro ao verificar a conta</h2>
            <p className="text-gray-600 mb-6">

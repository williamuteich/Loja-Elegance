...
export default function Produtos({ titulo, isDestaque }: { titulo: string; isDestaque: boolean }) {

  // Se isDestaque for false, mostra todos os produtos; caso contrário, filtra somente os produtos com destaque

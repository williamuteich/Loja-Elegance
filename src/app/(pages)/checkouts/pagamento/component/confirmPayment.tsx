...
export default function ConfirmPayment() {
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-white rounded-lg shadow-lg h-screen">
      <CheckCircleIcon className="w-12 h-12 text-green-600 mb-4" />
      <h2 className="text-2xl font-semibold text-green-600">¡Felicitaciones! Tu pedido ha sido confirmado</h2>
